...
async function collectAndSendData(session, redis_value) {
    try {
        ...
        json_AMS_MMixer.BatchID.value = Value_AMS_NMixer_BatchID.value.value;
        ...
        // console.log(json_ADW_DIWater);
        // console.log(json_AMC_CMixer);
        // console.log(json_AMC_CMCST);
        // console.log(json_AMC_CNTST);
        // console.log(json_AMS_MMixer);
        // console.log(json_AMS_Slurry1);
        // console.log(json_AMS_Slurry2);
        // console.log(json_AP_DP);
        // console.log(json_AP_MS1);
        // console.log(json_AP_MS2);
        // console.log(json_AP_SS);
        // console.log(json_AP_MDis);
        // console.log(json_AP_SDis);
        console.log(json_AP_VC);
...
async function main() {
    ...
    try{
        ...
        const redis_value = await redis_client.get('anode_main');
